...
const Title = ({ title }) => {
  return (
    <>
      ...
      <h3 className='self-start text-base sm:text-xl md:text-2xl mx-auto sm:m-0 px-4 sm:p-0 font-PoppinsBold border-b-2 border-spacing-14 text-pallete-black border-pallete-green inline'>
        {title}
      </h3>
    </>
  )
