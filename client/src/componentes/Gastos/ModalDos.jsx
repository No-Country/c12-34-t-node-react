...
const ModalDos = () => {
  return (
    <div className=' text-pallete-black'>
      <button className="btn btn-md px-10 py-1.5 mx-auto rounded-xl flex justify-center text-sm shadow-sm font-PoppinsSemibold bg-pallete-yellow hover:bg-pallete-yellow  leading-6 text-pallete-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pallete-blue" onClick={() => window.my_modal_3.showModal()}>Agregar</button>
      <dialog id="my_modal_3" className="modal mx-auto">
        <form method="dialog" className="modal-box bg-pallete-lightgrey">
