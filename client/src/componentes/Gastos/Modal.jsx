        ...
        <div className='px-4 py-6'>
          ...
          <div className='bg-white rounded-xl mt-4 p-4'>
            ...
            <div className='mb-4'>
              ...
              <input type='number' className='w-full bg-slate-300 rounded-lg py-2 px-3'  onChange={(e) => setExpense(e.target.value)}></input>
            </div>
  
            <div className='flex justify-center'>
              <button className='text-white btn btn-active btn-primary rounded-xxl w-[100px] mr-4' onClick={() => sendNewExpense()}>Agregar</button>
