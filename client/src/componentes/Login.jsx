  ...
  return (
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 rounded-lg bg-gray-200 p-4 w-[50vh]">
         <div className="sm:mx-auto sm:w-full sm:max-w-sm " >
           <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Inicio de sesion</h2>
         </div>
            ...
            <div className="flex items-center justify-between">
             ...
             <div className="mt-2">
                <input  id="email"  name="email" placeholder='email'  type="email" autoComplete="email"required onChange={(e) => setName(e.target.value)}
        ...
        <div>
          <div className="flex items-center justify-between">
            <label htmlFor="password" className="block text-sm font-medium leading-6 text-gray-900"> Email o Contraseña *</label>
            
          </div>
          <div className="mt-2">
            <input  id="password"  name="password"  placeholder='password' type="password"  autoComplete="current-password" required onChange={(e) => setPassword(e.target.value)}
