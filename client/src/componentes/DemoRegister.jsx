    ...
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <form className="space-y-6" action="#" method="POST">
        ...
        <div>
          ...
          <div className="mt-2">
            <input  id="email"  name="email" placeholder='usuario'  type="email" autoComplete="email"required
        ...
        <div>
          ...
          <div className="mt-2">
            <input  id="email"  name="email" placeholder='contraseña'  type="email" autoComplete="email"required
              className="block w-full rounded-md border-0 py-1.5 bg-black  text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-white focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
