...
const Register = () => {
  return (
    <div className='w-300'>
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 rounded-lg bg-gray-200 p-4 w-300">
    ...
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <form className="space-y-6" action="#" method="POST">
        ...
        <div>
          ...
          <div className="mt-2">
            <input  id="email"  name="email" placeholder='email'  type="email" autoComplete="email"required
              className="block w-full rounded-lg border-0 py-1.5 bg-slate-600  text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-white focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
        ...
        <div>
          ...
          <img src={gmail} style={{height:"3vh", marginRight:"2vh"}}></img>
           Sign up With Google 
          </button>
        </div>
